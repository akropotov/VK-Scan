        ...
        $('#content').animate({'opacity': 'hide'}, function() {
            ...
            html +=             '</td>\
                    ...
                    <div id="top_pay">\
                        ...
                        Для того, чтобы у вас появилась возможность смотреть ТОП-200, нужно сделать единоразовый взнос в размере <b>3 голоса</b>. После чего, вы сможете без ограничений пользоваться данной функцией. \
